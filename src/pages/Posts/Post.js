...
function Post(props) {
  ...
  let showmodalContent = showDetails ?
    ...
    (
      <>
        <div className="container my-4 modaledit">
          <div className="row">
      ...
      <main className='content'>
        ...
        <div className="border shadow p-4">
          <div className="container py-3 post-data">
            <Header title="Post" subtitle="Managing the Task of Members" />
            <button className="btn btn-dark mt-4" onClick={() => setShowModal(true)}>Add Post</button>
            <div className="post-table my-5">
              <table className="table table-striped table-hover table-light border">
                <thead>
                  <tr>
                    ...
                    Object.entries(postData).map((item) => (
                      <tr>
                        ...
                        <td>
                          ...
                          } className="btn btn-primary btn-sm ml-2">Edit</button>
                          <button type="button" id={item[0]} onClick={(e) => handleDelete(item[0], e)} className="btn btn-danger btn-sm ml-2">Delete</button>
                        </td>
                      </tr>
